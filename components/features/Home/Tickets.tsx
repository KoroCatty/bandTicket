    ...
    <>
      <section className="my-section-lg max-w-[860px] mx-auto max-[480px]:my-section-sm px-10 max-[480px]:px-1">
        <div className="relative text-[7rem] max-[1000px]:text-[5.5rem] max-[768px]:text-[5rem] max-[650px]:text-[4rem] max-[480px]:text-[3rem]">
          ...
          <span className=" absolute top-[-30%] left-0 opacity-10 mb-6 font-bold leading-[1.2]">
            EVENTS
          </span>
        </div>
        ...
        <div className="">
          ...
          {allTickets.map((ticket) => (
            ...
            >
              ...
              <Link
                href="/ticket/details"
                className="bg-btnBg ml-auto px-4 py-2 hover:bg-btnBg/80 transition-all duration-300 max-[480px]:mr-auto max-[480px]:ml-0"
              >
                Details
              </Link>
            </div>
          ...
          <Link
            href="/tickets"
            className="bg-btnBg text-xl text-white py-6 mt-10 block text-center tracking-wide hover:bg-btnBg/80 hover:scale-105 transition-all duration-300 max-[480px]:w-[70%] max-[480px]:mx-auto max-[480px]:py-4"
          >
            SHOW ALL TICKETS
          </Link>
        </div>
