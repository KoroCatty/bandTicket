...
const HeroMerch = () => {
  return (
    <section className="relative mt-[2rem] max-[768px]:mt-[1rem] ">
      <div className="absolute top-0 left-[0] w-[100%] pl-8 max-[900px]:top-[5%] max-[580px]:pl-1 max-[480px]:top-[30%] max-[480px]:text-center">
