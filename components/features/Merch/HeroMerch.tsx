...
const HeroMerch = () => {
  return (
    <section className="relative pt-[2rem] min-[1180px]:ml-[7vw] max-[580px]:pt-[0]">
      <div className="absolute top-0 left-[0] w-[100%] pl-8 min-[1180px]:mt-[3vh] max-[900px]:top-[5%] max-[580px]:pl-1 max-[480px]:top-[30%] max-[480px]:text-center pt-[2rem] max-[580px]:pt-[0] ">
