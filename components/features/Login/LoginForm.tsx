  ...
  return (
    <div className="my-6">
      ...
      <button
        ...
        className="relative left-[50%] -translate-x-[50%] text-[1.4rem] inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 
      max-[640px]:text-[1.3rem] max-[480px]:text-[1.2rem] "
      >
