  ...
  return (
    <>
      <article className="max-w-2xl mx-auto p-8 mt-16">
        <h1 className="text-4xl mb-7">Privacy Policy</h1>
        <p className="text-lg leading-relaxed mb-7">
          [ KZ-DEV ] is committed to providing quality services to you and this
        ...
        <div>
          <h2 className="text-3xl mb-4">Sensitive Information</h2>

          <p className="text-lg leading-relaxed mb-7">
            Sensitive information is defined in the Privacy Act to include
            information or opinion about such things as an individuals racial or
          ...
          <ul className="list-disc pl-5 text-lg leading-relaxed mb-7">
        ...
        <h2 className="text-3xl mb-4">Third Parties</h2>
        <p className="text-lg leading-relaxed mb-7">
        ...
        <div>
          <h3 className="text-3xl mb-4">Third Parties</h3>
          <p className="text-lg leading-relaxed mb-7">
        ...
        <div>
          <h2 className="text-3xl mb-4">Access to your Personal Information</h2>
          <p className="text-lg leading-relaxed mb-7">
        ...
        <h3 className="text-lg leading-relaxed">Victoria Australia</h3>

        <address className="text-lg leading-relaxed">
          kojima.website@gmail.com
        </address>
      </article>
    </>
  );
